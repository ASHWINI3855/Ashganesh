...
const FloatingButtons = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-3">
      {/* WhatsApp */}
      <a
        href="https://wa.me/916381951152?text=%F0%9F%8C%9F%20Welcome%20to%20The%20Corner%20Stone%20Groups%20-%20Your%20Career%20Partner!%20We're%20here%20to%20transform%20your%20Professional%20Journey%20with%20Personalized%20Placement%20Solutions.%20%F0%9F%92%BC%F0%9F%9A%80"
        target="_blank"
        rel="noopener noreferrer"
        className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center hover:bg-[#128C7E] hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-[#25D366]/40 group relative"
        title="WhatsApp"
      >
        <span className="absolute -inset-1 rounded-full bg-[#25D366]/40 animate-ping opacity-75"></span>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white relative z-10 transition-transform group-hover:scale-110">
